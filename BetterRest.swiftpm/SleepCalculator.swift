...
//        return bundle.url(forResource: "SleepCalculator", withExtension:"mlmodelc")!
//    }
    class var urlOfModelInThisBundle: URL {
        return try! MLModel.compileModel(at: URL(fileReferenceLiteralResourceName: "SleepCalculator.mlmodel"))
    }
    /**
